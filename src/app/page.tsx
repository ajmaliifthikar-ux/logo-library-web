    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans antialiased">
      ...
      <nav className="sticky top-0 z-40 border-b border-white/10 bg-[#0a0a0a]/80 backdrop-blur">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 bg-white rounded-sm flex items-center justify-center"><span className="text-black text-xs font-bold">L</span></div>
            <span className="text-sm font-medium tracking-tight">LogoLibrary</span>
          </div>
      ...
      <section className="border-b border-white/10">
        <div className="max-w-6xl mx-auto px-6 py-20 md:py-28">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-white mb-6 leading-tight">Open Source<br /><span className="text-neutral-500">Brand Logo Library</span></h1>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                {selectedBrandData.assets.map((asset) => {
                  ...
                  const attribution = `<!-- ${selectedBrandData.brand_name} logo via LogoLibrary (https://logo-explorer.vercel.app) -->\n<img src="${cdnUrl}" alt="${selectedBrandData.brand_name}" />`;
                  return (
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button onClick={() => handleCopy(`Check out LogoLibrary — ${stats.brands.toLocaleString()}+ brand logos & icons: https://logo-explorer.vercel.app`, "share", "Share text")} className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 border border-white/20 text-white rounded-lg text-sm font-medium hover:bg-white/5 transition-colors">
